...
with Sys_Exp_P.Valeur_P.Operateur_P.Multiplication_P.Test_P;

package body Feuille_Operateur_Multiplication_P
   with Spark_Mode => Off
is

   package Operateur_R renames Sys_Exp_P.Valeur_P.Operateur_P;
   package Scenario_R  renames Operateur_R.Multiplication_P.Test_P;
   ...
   is
      ...
      Nom_Test : constant String := "(Test opérateur multiplier) ";
   begin
            ...
            (
               T => Caller_P.Create
                  (
                     Name => Encode
                        (
                           Item => Nom_Test & "interpréter fait " &
                              "[" & I'Image & "]"
                        ),
