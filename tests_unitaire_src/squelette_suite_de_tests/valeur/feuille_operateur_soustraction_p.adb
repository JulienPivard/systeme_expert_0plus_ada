...
with Sys_Exp_P.Valeur_P.Operateur_P.Soustraction_P.Test_P;

package body Feuille_Operateur_Soustraction_P
   with Spark_Mode => Off
is

   package Operateur_R renames Sys_Exp_P.Valeur_P.Operateur_P;
   package Scenario_R  renames Operateur_R.Soustraction_P.Test_P;
   ...
   is
      ...
      Nom_Test : constant String := "(Test opérateur moins) ";
   begin
