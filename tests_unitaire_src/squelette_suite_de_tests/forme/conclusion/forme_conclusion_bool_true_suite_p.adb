...
with Sys_Exp_P.Forme_P.Conclusion_P.Bool_True_P.Test_P;

package body Forme_Conclusion_Bool_True_Suite_P
   with Spark_Mode => Off
is

   package Conclusion_R renames Sys_Exp_P.Forme_P.Conclusion_P;
   package Scenario_R   renames Conclusion_R.Bool_True_P.Test_P;
   ...
   is
      ...
      Nom_Test : constant String := "(Test conclusion vrais) ";
   begin
