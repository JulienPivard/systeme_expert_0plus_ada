...
package body Sys_Exp_P.Valeur_P.Operateur_P.Soustraction_P.Test_P
   with Spark_Mode => Off
is
   ...
   begin
      ...
      AUnit.Assertions.Assert
         (
            Condition => not T.Moins.Gauche.Is_Empty,
            Message   => "La valeur gauche ne doit pas être vide"
         );
      AUnit.Assertions.Assert
         (
            Condition => not T.Moins.Droite.Is_Empty,
   ...
   begin
      ...
      begin
         ...
         Valeur := T.Moins.Interpreter (Base => Base);
         AUnit.Assertions.Assert
            (
