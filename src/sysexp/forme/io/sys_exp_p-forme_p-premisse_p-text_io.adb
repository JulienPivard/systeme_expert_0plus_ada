...
is
   ...
   is
   begin
      if    Item in Bool_False_P.Premisse_T         then
         Bool_False_P.Text_IO.Put_Line
            (Item => Bool_False_P.Premisse_T         (Item));
      elsif Item in Bool_True_P.Premisse_T          then
         Bool_True_P.Text_IO.Put_Line
            (Item => Bool_True_P.Premisse_T          (Item));
      elsif Item in Expression_Entiere_P.Premisse_T then
         Expression_Entiere_P.Text_IO.Put_Line
            (Item => Expression_Entiere_P.Premisse_T (Item));
      elsif Item in Fait_Entier_P.Premisse_T        then
         Fait_Entier_P.Text_IO.Put_Line
            (Item => Fait_Entier_P.Premisse_T        (Item));
      elsif Item in Symbole_Constant_P.Premisse_T   then
         Symbole_Constant_P.Text_IO.Put_Line
            (Item => Symbole_Constant_P.Premisse_T   (Item));
      elsif Item in Symbole_Fait_P.Premisse_T       then
         Symbole_Fait_P.Text_IO.Put_Line
            (Item => Symbole_Fait_P.Premisse_T       (Item));
      end if;
   end Put_Line;
   ---------------------------------------------------------------------------
